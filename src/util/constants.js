...
module.exports = {
    ...
    DEFAULT_DEEP_SEA_MIN_WIPE_COOLDOWN_MS: 90 * 60 * 1000, /* 1h 30m */
    DEFAULT_DEEP_SEA_MAX_WIPE_COOLDOWN_MS: 150 * 60 * 1000, /* 2h 30m */
    DEFAULT_DEEP_SEA_WIPE_COOLDOWN_MS: 90 * 60 * 1000, /* Legacy field (min cooldown) */
    ...
    COLOR_DEEP_SEA_DETECTED: '#00CED1',
    COLOR_DEEP_SEA_LEFT: '#1F4E79',
    COLOR_DEEP_SEA_PREPARE: '#6EC4E8',
    ...
    COLOR_TEAMCHAT_SECONDARY: '#2B76CE',
