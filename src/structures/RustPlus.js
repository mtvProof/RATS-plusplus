...
const TOKENS_REPLENISH = 1.0;   /* Per second - ULTRA conservative to prevent constant disconnects */
...
class RustPlus extends RustPlusLib {
    constructor(guildId, serverIp, appPort, steamId, playerToken) {
        ...
        this.isPollingHandlerRunning = false; /* Is the polling handler currently executing? */
    ...
    getCommandDeepSea(isInfoChannel = false) {
        ...
        const deepSeaMinWipeCooldown = deepSeaSettings.deepSeaMinWipeCooldownMs ??
            deepSeaSettings.deepSeaWipeCooldownMs ??
            (90 * 60 * 1000);
